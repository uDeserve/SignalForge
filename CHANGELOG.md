...
- live end-to-end GitHub App publication and decision loop documented in `docs/live-e2e.md`
- adapter and CLI tests for the small-team integration path

### Notes

- current focus is mature adoption for small web teams and independent developers
- the long-term direction remains user reality -> case -> GitHub issue -> agent / maintainer execution
