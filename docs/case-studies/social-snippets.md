...
Modern AI coding workflows are getting strong at issue -> code -> PR.
...
Real incidents do not arrive pre-labeled.

In Omni Lingua, a backend hang can first appear as:

- frontend still opens
